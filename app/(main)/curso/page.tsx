...
export default function CoursePlayerPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-80px)] overflow-hidden bg-bg-mist relative">
      
      {/* --- HEADER DEL PLAYER --- */}
      <div className="h-14 bg-white border-b border-gray-200 flex items-center px-4 justify-between shrink-0 z-20">
         <div className="flex items-center gap-4">
             <Link href="/cursos" className="flex items-center gap-2 text-sm text-gray-500 hover:text-primary-turquoise font-medium">
                <ChevronLeft size={18}/> <span className="hidden sm:inline">Mis cursos</span>
             </Link>
             <div className="h-4 w-px bg-gray-300 hidden sm:block"></div>
             <h1 className="text-sm font-bold text-text-darkBlue uppercase truncate max-w-[200px] sm:max-w-md">
         ...
         <button 
            className="lg:hidden p-2 text-text-darkBlue hover:bg-gray-100 rounded-md"
      ...
      <div className="flex grow overflow-hidden relative">
        ...
        <div className="grow overflow-y-auto p-4 md:p-8 scroll-smooth">
            {contentType === 'video' && (
                <div className="max-w-4xl mx-auto animate-in fade-in duration-500">
                    <div className="aspect-video bg-black rounded-xl overflow-hidden shadow-lg relative group cursor-pointer mb-6">
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                        <h2 className="font-playfair font-bold text-xl mb-4">Introducción al Módulo</h2>
        ...
        <div className={clsx(
            ...
            <div className="flex justify-between items-center p-4 border-b border-gray-100">
                <span className="font-bold text-text-darkBlue">Temario</span>
